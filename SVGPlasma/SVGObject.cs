...
{    
    class SVGObject
    {
        ...
        public bool isPointInside(SVGPoint p)
        {
            ...
            SVGPoint extreme = new SVGPoint(100000, p.y);
        ...
        private bool onSegment(SVGPoint p, SVGPoint q, SVGPoint r)
        {
        ...
        // 1 --> Clockwise
        // 2 --> Counterclockwise
        int orientation(SVGPoint p, SVGPoint q, SVGPoint r)
        {
        ...
        // and 'p2q2' intersect.
        bool doIntersect(SVGPoint p1, SVGPoint q1, SVGPoint p2, SVGPoint q2)
        {
